...
class _EnhanceExpansionTileState extends State<EnhanceExpansionTile>
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            widget.childrenHeader?.call(_handleTap) ?? const SizedBox(),
            ClipRect(
              child: Align(
            ...
            widget.childrenFooter?.call(_handleTap) ?? const SizedBox(),
          ],
        ),
      ),
    );
