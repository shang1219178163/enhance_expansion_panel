...
class _EnhanceExpandIconState extends State<EnhanceExpandIcon> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: IconButton(
        ...
        // ),
        icon: (widget.arrow != null && widget.arrowExpanded != null) ? (widget.isExpanded ? widget.arrowExpanded! : widget.arrow!) : RotationTransition(
          turns: _iconTurns,
          child: Icon(Icons.expand_more, color: _iconColor,),
        ),
      ),
